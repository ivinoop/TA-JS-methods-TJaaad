...
let res = fruits.map(function () {
  return fruits[0] === ' Dragon Fruit' && fruits[1] === 'Guava';
});
...
let oddNumbers = numbersThree.map (num => {
  console.log(num % 2 !== 0);
});

// Create a new variable named evenNumbers that store all the even numbers in numbersThree array

let evenNumbers = numbersThree.map (num => {
  console.log(num % 2 === 0);
});

// Find the index of 10 in numbersThree array

let indexFind = numbersThree.findIndex (num => {
  return num === 10;
});
...
console.log((fruits.toUpperCase(fruits.join('-'))));

// Join all fruits with '&', convert to lowercase and log it

console.log((fruits.toLowerCase(fruits.join('-'))));