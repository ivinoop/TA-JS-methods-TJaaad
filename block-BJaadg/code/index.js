...
let indexOfIs = console.log(quote.indexOf('is'));
...
console.log(`The index of first "is" in "quote" variable is ${quote.indexOf('is')}`);
...
console.log(`${from} said ${from.concat(quote)}`);
...
quoteSplit[quoteSplit.length-1] = "tomorrow";
console.log(quoteSplit.join(' '));
