...
console.log(`The index of first "is" in "quote" variable is ${quote.charAt(indexOfIs)}`);
...
/*
10. Split the quote into individual word and store it in a variable name quoteSplit
*/

let quoteSplit = quote.split(" ");

/*
11. Change the word "today" in quoteSplit to "tomorrow" and join all the words to form a sentance.
*/

let index = quoteSplit.indexOf('today');
quoteSplit[index] = "tomorrow";
quoteSplit.join(" ");
...
let padVariable = quote.padStart(70, '.');
